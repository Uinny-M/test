...
<%--      </button>--%>
<%--&lt;%&ndash;      <h3>Назначения в страховом случае</h3>&ndash;%&gt;--%>
<%--&lt;%&ndash;      <table class="table table-striped table-bordered">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <thead>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <th colspan="4">Список назначений</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <th width="25%">Тип манипуляции</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <th width="25%">Продолжительность</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <th width="25%">Дата начала</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;          <th width="25%">Подробности</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </thead>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <tbody>&ndash;%&gt;--%>
<%--&lt;%&ndash;        <c:forEach items="${prescriptions}" var="p">&ndash;%&gt;--%>
<%--&lt;%&ndash;          <tr>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>${p.manipulation.title}</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>${p.duration} дн.</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>${p.startDate}</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <td>${p.drug}</td>&ndash;%&gt;--%>
<%--&lt;%&ndash;          </tr>&ndash;%&gt;--%>
